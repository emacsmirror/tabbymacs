...
It displays completions as /ghost text/, similar to GitHub Copilot, but is powered by [[tabby.tabbyml.com][Tabby]]
...
- =tabbymacs-send-changes-idle-time= (default: =0.5=)
  - Defines time in seconds to wait before sending changes notifycation to tabby-agent
